...
This skill is installed into the repository, so the script path is relative to the
project root. Run it from the project root, or prefix the absolute repo path:
